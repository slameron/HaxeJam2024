...
class FlxSoundTray extends Sprite
{
	...
	public function new()
	{
		...
		#else
		#end
		var dtf:TextFormat = new TextFormat('Nokia Cellphone FC Small', 10, 0xffffff);
	...
	public function show(up:Bool = false, ?newVol:Float, ?label:String):Void
	{
		if (!silent)
		{
		...
		visible = true;
		active = true;
		var globalVolume:Int = Math.round((newVol != null ? newVol : FlxG.sound.volume) * 10);
